...
public static class GatewayDeviceUtility
{
    private static bool searching = true;

    private static GatewayDevice defaultGateway;

    static GatewayDeviceUtility()
    {
        FindGateway();
    }
    ...
    {
        if (GatewayDevice.TryNew(ip, out GatewayDevice gateway))
        {
